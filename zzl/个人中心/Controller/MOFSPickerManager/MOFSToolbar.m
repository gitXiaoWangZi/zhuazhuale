...
#define BAR_COLOR systemColor
#define LINE_COLOR DYGColorFromHex(0xf2f2f2)
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self.titleBar setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:14],
