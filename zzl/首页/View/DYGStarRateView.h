...
//  DYGStarRateView
//
//  Created by 杜谕罡 on 16/4/1.
//  Copyright © 2016年 dyg. All rights reserved.
//

#import <UIKit/UIKit.h>
@class DYGStarRateView;
...
@protocol DYGStarRateViewDelegate <NSObject>

-(void)starRateView:(DYGStarRateView *)starRateView currentScore:(CGFloat)currentScore;

@end

@interface DYGStarRateView : UIView

@property (nonatomic,assign)BOOL isAnimation;       //是否动画显示，默认NO
@property (nonatomic,assign)RateStyle rateStyle;    //评分样式    默认是WholeStar
@property (nonatomic, weak) id<DYGStarRateViewDelegate>delegate;
