...
//全屏的
#define TopColorArr  @[(id)DYGColorFromHex(0xff9600).CGColor, (id)DYGColorFromHex(0xfff660).CGColor]

#define BottomColorArr @[ (id)DYGColor(248, 151, 0).CGColor,(id)DYGColor(252, 233, 81).CGColor]
...
- (void)updateProgress:(CGFloat)progress
{
    ...
    if (progress == 1) {
        self.topLayer.colors = @[(id)DYGColorFromHex(0xff9600).CGColor, (id)DYGColorFromHex(0xfff660).CGColor];
        self.bottomLayer.colors = @[(id)DYGColor(248, 151, 0).CGColor,(id)DYGColor(252, 233, 81).CGColor];
    }
}

- (void)updateFillColorToRed
{
    self.topLayer.colors = @[(id)DYGColorFromHex(0xef313a).CGColor, (id)DYGColorFromHex(0xfb6a43).CGColor];
}
